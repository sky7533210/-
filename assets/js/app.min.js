...
function setupDelete(e, a, t, n, l, i, o) {
        ...
        e.preventDefault(),
            ...
            bootbox.confirm({
                ...
                callback: function(e) {
                    ...
                    window.location.href="/file/delete?ids="+a[0]["value"]+"&parentid="+a[1]["value"];
    ...
    $(document).on("click", ".removelink", s),
        $(document).on("click", ".multic", function(e) {
            e.preventDefault();
            var a, r, s = [];
            r = 1 == t ? $(".selecta:checked", oTable.rows().nodes()) : $(".selecta:checked"),
                a = r.size(),
                a > 0 ? (r.each(function() {
                        s.push($(this).val())
                    }),
                        ...
                        $("#delform").append('<input class="daishan" type="hidden" name="h" value="' + l + '">'),
                        $("#delform").append('<input class="daishan" type="hidden" name="doit" value="' + i + '">'),
