...
* call resumable.js
*/
function resumableJsSetup($android, $placeholder, $singleprogress,$parentid) {
	$android = $android || 'no';
    ...
    if (r.support && android == 'no') {
        ...
        if ($singleprogress == true) {
            r.on('fileProgress', function(file,message){   //感觉没用
        ...
        r.on('fileSuccess', function(file, event){ //感觉没用
